...
def plot_track_data(updated_states):
    ...
    for i, txt in enumerate(updated_states):
        plt.annotate(f"{txt[1]:.2f}", (times[i], ranges[i]), textcoords="offset points", xytext=(0,10), ha='center')
...
def main():
    ...
    tracks, track_ids = initialize_tracks(grouped_measurements)
